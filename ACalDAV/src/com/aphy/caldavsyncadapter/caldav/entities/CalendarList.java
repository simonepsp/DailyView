...
//	private static final String TAG = "CalendarList";
    ...
    public DavCalendar.CalendarSource Source = DavCalendar.CalendarSource.undefined;
    ...
    public CalendarList(Account account, ContentProviderClient provider, DavCalendar.CalendarSource source,
                        String serverUrl) {
