...
package com.aphy.caldavsyncadapter.syncadapter;
...
import com.aphy.caldavsyncadapter.syncadapter.notifications.NotificationsHelper;
...
//                + account.name + " with URL " + url);
        ...
        CalendarList androidCalList = new CalendarList(account, provider, DavCalendar.CalendarSource.Android,
                url);
